...
// =========================
// SkipList: TestCase15.java
// =========================
// This test case manually checks the structure of a small skip list after
// performing a few insertions and deletions. This is very similar to
// TestCase14.java. The difference is the order in which the repeat values are
// inserted.
...
public class TestCase15
{
	...
	public static void main(String [] args)
	{
		...
		int [] newHeights = new int[] {5, 2, 3, 2, 4, 1, 5};
		Node<Integer> temp = s.head();
		...
		success &= referenceCheck(s, level = 1, new int [] {10, 15, 20, 30});
		success &= referenceCheck(s, level = 2, new int [] {15, 30});
		...
		newHeights = new int[] {3, 2, 3, 2, 1, 3};
		temp = s.head();
		for (int i = 0; i < newHeights.length; i++)
		{
			success &= (temp.height() == newHeights[i]);
