...
# with your SneakyQueens.java file and all the test case files (source files,
# input files, and output files), and do the following:
#
...
#
#       chmod +x run-all-test-cases.sh
#
# 2. Run this script like so:
#
#       ./run-all-the-test-cases.sh
#
################################################################################
...
do
	...
	diff myoutput0$i.txt TestCase0$i-output.txt > /dev/null
	diff_val=$?
